...
/**
 * Modifiable array of bytes. Contains
 */
public class ByteArrayList extends ArrayList<Byte> {
  ...
  /**
   * Adds the specified integer in its binary form. 4 bytes will be added in total.
   *
  ...
  /**
   * Gets an integer value from this list using the byte at {@code startIndex} and the 3 following
   * bytes.
   *
   * @param startIndex first byte of the integer value
   * @return integer converted from bytes
   * @throws IndexOutOfBoundsException if {@code startIndex < 0} or  {@code startIndex > (size() -
   *                                   4) }
   */
  ...
  /**
   * Adds the specified short in its binary form. 2 bytes will be added in total.
   *
  ...
  /**
   * Gets an short value from this list using the byte at {@code startIndex} and the following
   * byte.
   *
  ...
  /**
   * Inserts the rightmost 8 bits of the specified integer at the specified index to the list. See
   * {@link ArrayList#add(int, Object)} for further information.
   *
   ...
   * @throws IndexOutOfBoundsException if {@code byteIndex < 0} or {@code byteIndex >= size()} or
   *                                   {@code bitIndex < 0 } or {@code bitIndex > 7}
   */
   ...
   * @throws IndexOutOfBoundsException if {@code index < 0} or {@code index >= size()} or {@code
   *                                   size < 1 } or {@code size > size - index}
   */
