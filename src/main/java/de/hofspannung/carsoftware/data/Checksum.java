...
public class Checksum {
  ...
  /**
   * Calculates the fletcher's checksum and appends it to the specified data. The checksum is added
   * in a way, that wen calculating the checksum over the result, it returns 0 if the data is
   * correct. Use {@link Checksum#checkFletcher(ByteArrayList)} to check.
   *
